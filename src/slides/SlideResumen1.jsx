            ...
            <div className="flex-1 p-4 flex flex-col">
              ...
              <div className="flex-1 flex items-center">
                <div className="grid grid-cols-2 gap-x-6 gap-y-4 w-full">
                  ...
                  {/* Spotify + YouTube */}
                  <div className="text-center">
                    <div className="h-12 mx-auto mb-2.5 rounded-xl bg-white/[0.04] flex items-center justify-center gap-1.5 px-3">
                      ...
                      <svg width="20" height="20" viewBox="0 0 24 24" className="text-[#FF0000]">
